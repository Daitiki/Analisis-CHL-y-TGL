# Analisis-CHL-y-TGL
# Encontrar los valores de referencias normales de colesterol y trigliceridos en estudiantes
import pandas as pd
import numpy as np
...
df = pd.read_csv("DF_CHL_TGL_EJEMPLO")
...
#Correlacion entre CHL y TGL con el IMC
correlacion_chl = df_datos['CHL'].corr(df_datos['IMC'])
print("Coeficiente de correlación:", correlacion_chl)

correlacion_TGL = df_datos['TGL'].corr(df_datos['IMC'])
print("Coeficiente de correlación:", correlacion_TGL)
